...
<Cards>
  <Card title="言枢" description="配置化应用、命名路由、反向 URL、中间件、错误与测试客户端" href="/ecosystem/web/framework/" />
  <Card title="言标" description="内建的中文 HTML 超集：自动转义、控制流、包含与继承" href="/ecosystem/web/yanbiao/" />
  <Card title="安全 HTML" description="底层节点、属性、URL 白名单和显式原始内容" href="/ecosystem/web/html/" />
  <Card title="HTTP/1.1" description="严格且受预算约束的请求、响应与连接基础" href="/ecosystem/web/http/" />
  <Card title="言枢博客" description="同时提供页面、JSON、言据和静态文件的完整参考项目" href="/ecosystem/web/webblog/" />
</Cards>
